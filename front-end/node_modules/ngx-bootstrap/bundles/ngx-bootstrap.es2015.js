import { isDevMode, Injectable, Component, Input, HostBinding, Inject, Output, EventEmitter, Directive, ElementRef, Renderer2, NgModule, ChangeDetectionStrategy, ChangeDetectorRef, HostListener, forwardRef, Optional, NgZone, ViewChild, ReflectiveInjector, TemplateRef, ApplicationRef, ComponentFactoryResolver, Injector, ViewContainerRef, Host, RendererFactory2, ViewEncapsulation, ViewChildren } from '@angular/core';
    ...
    setEventHandlers(container) {
        ...
        container.monthSelectHandler = (event) => {
            ...
            this._store.dispatch(this._actions.navigateTo({
                unit: { month: getMonth$1(event.date) },
                viewMode: 'day'
            }));
        };
        container.yearSelectHandler = (event) => {
            ...
            this._store.dispatch(this._actions.navigateTo({
                unit: { year: getFullYear$1(event.date) },
                viewMode: 'month'
            }));
        };
        return this;
...
function flagDaysCalendar(formattedMonth, options) {
    formattedMonth.weeks.forEach((week, weekIndex) => {
        week.days.forEach((day, dayIndex) => {
            ...
            const isSelected = (!isOtherMonth && isSameDay$1(day.date, options.selectedDate)) ||
                isSelectionStart ||
                isSelectionEnd;
...
let monthsShortDot$6 = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_');
let monthsShort$9 = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split('_');
const esUsLocale$1 = {
    abbr: 'es-us',
    months: 'enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre'.split('_'),
    monthsShort(date, format, isUTC) {
...
let monthsShortDot$7 = 'xan._feb._mar._abr._mai._xuñ._xul._ago._set._out._nov._dec.'.split('_'), monthsShort$10 = 'xan_feb_mar_abr_mai_xuñ_xul_ago_set_out_nov_dec'.split('_');
let monthsParse$8 = [/^xan/i, /^feb/i, /^mar/i, /^abr/i, /^mai/i, /^xuñ/i, /^xul/i, /^ago/i, /^set/i, /^out/i, /^nov/i, /^dec/i];
let monthsRegex$7 = /^(xaneiro|febreiro|marzo|abril|maio|xuño|xullo|agosto|setembro|outubro|novembro|decembro|xan\.?|feb\.?|mar\.?|abr\.?|mai\.?|xuñ\.?|xul\.?|ago\.?|set\.?|out\.?|nov\.?|dec\.?)/i;
const glLocale$1 = {
    abbr: 'gl',
...
let monthsParse$11 = [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^ма[йя]/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i, /^дек/i];
...
const monthsShort$11 = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split('_');
